import type { ChargeHideType, Move } from "../types/move";
...
// 위 9개는 원래 이 파일에 정의돼 있었으나 ver.1.5 §4에서 types/battle.ts로 옮겼다 — 아래에서
// 그대로 재export해 기존 소비처(BattleLogPage.tsx 등)의 import 경로는 안 바뀌어도 되게 한다.
export type {
  ActionLogEntry,
  FighterKey,
  HitAbilityEvent,
...
function resolveHitAndApplyDamage(input: HitResolutionInput) {
