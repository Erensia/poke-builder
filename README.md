...
- [docs/phase7.5-plan.md](docs/phase7.5-plan.md) — Phase 7.5 기획: 파티 선출·교체 인프라(6슬롯 BattleState·교체 액션·등장 시 처리), 상대 진영 설치 기술 6종, 플라워베일·공생, 1대1 우회 복원(가속·곡예·씨뿌리기 등)
...
- 🔲 Phase 7.5: 파티 선출·교체 인프라(6슬롯 BattleState·교체 액션·등장 시 처리 파이프라인) + 상대 진영 설치 기술 6종 + 플라워베일·공생 + 1대1 우회 복원 ([docs/phase7.5-plan.md](docs/phase7.5-plan.md))
