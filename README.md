...
- [1.8-backlog.md](docs/00_기획문서/1.8-backlog.md) — ver.1.8(진행 중): 도감 특성 문구 정비 + 갈지자걸음·총대장 엔진 배선(트랙 J, 완료), 도감 폼 탭 — 폼별 종족값·특성·기술 표기(트랙 K, 완료), AI 파티 단위 평가 ①(대면표 + 미니맥스, 그리디 상대 458 → 485승), ②(효과를 이어지는 대면에 남기기 — 구현, 기본값 끔)
