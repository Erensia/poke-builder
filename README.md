...
- [docs/phase7-plan.md](docs/phase7-plan.md) — Phase 7 기획: 대전 로그 문구 전면 정비(톤·형식·정보량 통일, 차징 기술 문구 포함), 상대 진영 설치 기술(파티 선출·교체 인프라 선행), 곁다리 특성 로직(복안·페어리오라·매직가드·매직미러·인분 완료 / 플라워베일·공생 남음), 로스터 확장(플라엣테·픽시)
...
- 🔲 Phase 7: 대전 로그 문구 전면 정비(톤·형식·정보량 통일, 차징 기술 문구 포함 — Phase 6.5 §4 이월), 상대 진영 설치 기술(파티 선출·교체 인프라 선행 — Phase 6.5 §8 이월), 곁다리 특성 로직(복안·페어리오라·매직가드·매직미러·인분 배선 완료, 플라워베일·공생 남음), 로스터 확장(플라엣테·픽시, 48종) ([docs/phase7-plan.md](docs/phase7-plan.md))
