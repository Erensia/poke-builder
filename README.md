...
- 🔲 Phase 8: 배틀타워 리뉴얼 — 파티 선출(3마리)·교체 인프라(파티 배열 BattleState·교체 액션·등장 시 처리 파이프라인) + 상대 진영 설치 기술 6종 + 플라워베일·공생 + 1대1 우회 복원(가속·곡예·씨뿌리기 등) ([docs/phase8-plan.md](docs/phase8-plan.md))
